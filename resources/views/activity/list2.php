...
<ul>
    ...
    <li id="<?php echo $activity->id ?>" class="booking-card" style="background-image: url(https://images.unsplash.com/photo-1578944032637-f09897c5233d?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=400&fit=max&ixid=eyJhcHBfaWQiOjE0NTg5fQ)">
...
<script>
    // detaya tıklandığında detay urlini açar
    /*
